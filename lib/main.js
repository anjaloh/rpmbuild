...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield exec.exec(`cp /github/workspace/${specFilePath} /github/home/rpmbuild/SPECS/`);
            yield exec.exec(`spectool --get-files --all /github/home/rpmbuild/SPECS/${specFilePath}`);
            yield exec.exec(`dnf builddep -y github/home/rpmbuild/SPECS/${specFilePath}`);
            try {
                yield exec.exec(`rpmbuild -ba github/home/rpmbuild/SPECS/${specFilePath}`);
            }
            catch (err) {
