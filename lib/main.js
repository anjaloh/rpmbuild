...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let outputRPM = '';
            child_process_1.default.exec('ls /github/home/rpmbuild/RPMS/', (err, stdout, stderr) => {
                if (err) {
            ...
            core.setOutput('asset_paths', `rpmbuild/SRPMS/${outputSRPM};rpmbuild/RPMS/x86_64/${outputRPM}`); // Paths to RPM and Source RPM files
